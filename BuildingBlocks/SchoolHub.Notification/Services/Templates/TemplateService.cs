           ...
           if(notification == 1)
            {
               ...
               "<br/> Email Address: <b>{emailAddress}</b><br/>Password: <b>{password}</b><br/><br/>Thanks for choosing this platform</div>";
            }
           else if(notification == 2)
            {
                template = "<div style=\"padding: 5px; \"><b>Dear {username}</b>,<br/><br/> Your password change was successful.<br/><br/>" +
                    "You will have to Login to update you profile<br/>Thanks for choosing this platform</div>";
            }
           else if(notification == 3)
            {
                template = "<div style=\"padding: 5px; \"><b>Dear {username}</b>,<br/><br/> Your reset was successful. <br/><br/> Below is your new Password" +
              "<br/>Password: <b>{password}</b><br/><br/>Thanks for choosing this platform</div>";
            }
